...
require_once(__DIR__ . "/DingClient/CorpMessageCorpconversationAsyncsendRequest.php");
include_once(__DIR__ . "/DingClient/ResultSet.php");
include_once(__DIR__ . "/DingClient/TopLogger.php");
include_once(__DIR__ . "/DingClient/RequestCheckUtil.php");

class DingTalkClient extends ServiceProvider
{
