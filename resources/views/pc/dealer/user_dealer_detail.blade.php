<div class="user_v_content" ng-show="loaded">
	...
	<div class="info_panel col-xs-6 bg_white">
		<div class="row info_header margin0">
			...
			<div class="col-xs-3 text-center">
				<a class="user_view_btn fontsize1_0" ng-href="#!/user/dealer/edit/{?dealer.id?}" class="edit_btn fontsize0_9" ng-show="dealer.can_edit">@lang('lang.pr_item_edit')</a>
			</div>
		</div>
	...
	<div class="user_panel col-xs-6 bg_white">
		<div class="row info_header margin0">
