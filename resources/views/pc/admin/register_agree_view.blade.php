...
<div class="conter-wrapper col-md-10" ng-show="loaded">
	<div class="panel panel-info float-center">
		...
		<div class="panel-body">
			...
			<div class="col-md-6">
				<label class="control-label">@lang('lang.register')@lang('lang.ov_status')</label>
					<pre><span ng-show="card.status==2">@lang('lang.sl_registered')</span><span ng-show="card.status==1 && card.agree_reg=='d'">@lang('lang.rg_card_cancled')</span> </pre>
			</div>

			<div class="col-xs-6 text-center" ng-show="card.status==1 && card.agree_reg=='r'">
				<div class="col-xs-12">
					<a class="btn btn-primary" ng-click="agree_register()" ng-disabled="ajax_loading">@lang('lang.agree')<span class="loading_icons" ng-show="ajax_agree_loading">&nbsp;&nbsp;<img src="./images/loading_now.gif"></span></a>
					<a class="btn btn-warning" ng-click="disagree_register()" ng-disabled="ajax_loading">@lang('lang.od_disagree')<span class="loading_icons" ng-show="ajax_disagree_loading">&nbsp;&nbsp;<img src="./images/loading_now.gif"></span></a>
				</div>
