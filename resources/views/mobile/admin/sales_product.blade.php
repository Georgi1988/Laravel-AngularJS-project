<div class="subheader bg_white">
	<div class="col-xs-4 text-center">
		<a href="#!/sales/rank/product"> 
			<span class="item active">@lang('lang.sl_register_ranking')</span>
		</a>
	</div>
	<div class="col-xs-4 text-center">
	...
	<div class="col-xs-4 text-center">
		<a href="#!/sales/rank/dealer"> 
			<span class="item">@lang('lang.sl_dealer_ranking')</span>
		</a>
	</div>
</div>
...
<div class="sales_content">
	...
	<div class="bg_white item out_border1" ng-repeat = "item in items">
		...
		<div class="col-xs-7 nopadding text-left">
			...
			<p class="margin0">
				<div class="col-xs-12 padding0 color_39f">@lang('lang.ov_sale_cards'): {?item.total_count?}</div>
				<div class="col-xs-6 padding0 color_39f">@lang('lang.activation_short')：{?item.activation_count?}</div>
				<div class="col-xs-6 padding0 color_39f">@lang('lang.ov_register')：{?item.register_count?}</div>
			</p>
		</div>
