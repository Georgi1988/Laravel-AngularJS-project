		...
		<div class="col-xs-3 nopadding text-center more">
			<div ng-if="item.is_approval==0">
				...
				<a 
					...
					data-toggle="modal" data-target=".reg_success_modal" 
					ng-click="onGive(item.id, item.dealer.name, item.user.name, item.red_packet_setting.redpacket_price)">
					{? item.red_packet_setting.redpacket_price ?} @lang('lang.label_cn_cunit')<br>
					@lang('lang.send')
				</a>
			</div>
