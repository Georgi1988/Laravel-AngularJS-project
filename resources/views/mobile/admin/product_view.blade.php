...
<div class="prod_v_content" style="display:none">
	...
	<div class="info">
		<div class="col-xs-6 nopadding">
			<div class="type col-xs-6 paddingleft8 text-right">@lang('lang.state') :</div>
			<div class="value col-xs-6 nopadding"><span ng-if="product.status">@lang('lang.use_on')</span><span ng-if="!product.status">@lang('lang.use_off')</span></div>
		</div>
		<div class="col-xs-6 nopadding">
	...
	<div class="info">
		<div class="col-xs-6 nopadding">
			<div class="type col-xs-6 paddingleft0 text-right">@lang('lang.cost_price') :</div>
			<div class="value col-xs-6 nopadding">
				{?product.price_sku?} @lang('lang.label_cn_cunit')
			</div>
		</div>
		<div class="col-xs-6 nopadding">
			<div class="type col-xs-6 paddingleft8 text-right">@lang('lang.pr_standard_price_s') :</div>
			<div class="value col-xs-6 nopadding">
	...
	<div class="col-xs-12 text-center">
		<a ng-href="#!price/edit/{?product.id?}" class="btn btn-primary width30 margintop20 marginbot20">@lang('lang.price_pricing')</a>
	</div>
