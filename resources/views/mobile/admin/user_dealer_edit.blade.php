<div class="user_v_content" style="display:none; font-size: 12px;">
	<div class="name_panel bgdef">
		...
		<div class="row margin0 paddingtop10">
			<div class="col-xs-12 text-muted">@lang('lang.person_charge')&nbsp;&nbsp;{? dealer.president.name ?} <i class="glyphicon glyphicon-phone" aria-hidden="true"></i>{?dealer.president.link?}</div>
		</div>
		<div class="row margin0 paddingtop10">
	...
	<form id="dealer_info_form" name="dealer_info_form" ng-submit="dealer_info_save()" style="font-size:12px;">
		<div class="info_panel col-xs-12 bg_white">
			<div class="row info_header margin0">
				<div class="col-xs-9 label_str">{? subject == 'dealer' ? "@lang('lang.label_dealer_information')" : "@lang('lang.label_store_information')" ?}</div>
			...
			<div class="col-xs-12 paddingtop10" ng-show="dealer.level == 1">
