...
<div class="prod_v_content" style="display:none">
	<div class="info">
		<div class="type col-xs-3 text-right">@lang('lang.code'):</div>
		<div class="value col-xs-8 nopadding">{?product.code?}</div>
	</div>
	<div class="info">
		<div class="type col-xs-3 text-right">@lang('lang.define_name'):</div>
		<div class="value col-xs-8 nopadding">{?product.name?}</div>
	</div>
	<div class="info">
		<div class="type col-xs-3 text-right">@lang('lang.type'):</div>
		<div class="value col-xs-8 nopadding">{?product.typestr_level1?} - {?product.typestr_level2?}</div>
	</div>
	<div class="info">
		<div class="type col-xs-3 text-right">@lang('lang.state'):</div>
	...
	<div class="info">
		<div class="col-xs-6 nopadding">
			<div class="type col-xs-6 text-right">@lang('lang.valid period'):</div>
			<div class="value col-xs-6 nopadding">
				<span>{? product.valid_period | months_to_string ?}</span>
			</div>
		</div>
		<div class="col-xs-6 nopadding">
			<div class="type col-xs-6 text-right">@lang('lang.pr_standard_price_s'):</div>
			<div class="value col-xs-6 nopadding">
	...
	<div class="info">
		<div class="type col-xs-3 text-right">@lang('lang.introduce'):</div>
	</div>
	<div class="info col-xs-10 col-xs-offset-1 padding0">{?product.description?}</div>
	<div class="clearfix"></div>
</div>

<!--<div class="prod_v_activation bg5ac8fa text-center">
	<a ng-href="#!activation/active/{?product.id?}">@lang('lang.activate_card')</a>
</div>-->