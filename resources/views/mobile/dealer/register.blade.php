...
<div class="reg_content">
	<div class="col-xs-12 bg_white nopadding marginbot10 item out_border1" ng-repeat = "item in items">
		<a href="#!/register/edit/{?item.product_id?}/{?item.id?}">
			...
			<div class="col-xs-10 no">
				<div class="col-xs-12 nopadding title" style="padding-bottom:10px;">{?item.name?}</div>
			...
			<div class="col-xs-2 nopadding text-center more" style="line-height:300%">&gt;</div>
		</a>
	</div>
