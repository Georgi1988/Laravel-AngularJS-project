...
<div class="row bg_white nomargin margintop20 border-top-1-EEE border-bot-1-EEE">
	<h1 class="overview_menu_label color_blue">@lang('lang.ov_card_business')</h1>
		...
		<tr>
			<td class="active">
				<a href="#!activation/active">
					<span class="menu_icon menu_bg_393"><img class="" src="./images/m_activation.png"></span><br>
					@lang('lang.activation')
				</a>
			</td>
			<td>
				<a href="#!register">
					<span class="menu_icon menu_bg_066"><img class="" src="./images/m_register.png"></span><br>
					@lang('lang.register')
				</a>
			</td>
			<td>
...
<div class="row bg_white nomargin margintop20 paddingbot20 border-top-1-EEE border-bot-1-EEE">
